...
<p class="date">Issued on ${certDate}</p>
    ...
    Recommendations: ${recommendations?.join("; ")}`,
      ...
      if (!aiResp.ok) {
        ...
        console.error("Gemini AI error:", aiResp.status, errText);
      ...
      analysisContent = cleanAIText(rawText);
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    <div class="header">
    <span class="logo">🌿 ClimaCode</span>
    <span class="date">${reportDate}</span>
    </div>

    <h1>Carbon Audit Report</h1>

    <p style="font-size:16px;color:#16a34a;font-weight:600;margin-bottom:24px">
    ${url}
    </p>
    ...
    <div class="footer">
    Generated by ClimaCode — ${reportDate}
    </div>
