    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-12 max-w-3xl">
        ...
        <div className="flex justify-center mb-12">
          <Button onClick={handleScan} disabled={loading || !url || !country} size="lg" className="rounded-full px-10 text-base font-semibold">
          ...
          {result && !loading && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              ...
              <div className="flex justify-center gap-4 pt-4">
                <Button size="lg" className="rounded-full px-8" onClick={handleDownloadPDF} disabled={reportLoading}>
